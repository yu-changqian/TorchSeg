...
class SegEvaluator(Evaluator):
    def func_per_iteration(self, data, device):
        ...
        pred = self.sliding_eval(img, label, config.eval_crop_size,
    ...
    def sliding_eval(self, img, label, crop_size, stride_rate, device=None):
        ...
        for s in self.multi_scales:
            ...
            processed_pred += self.scale_process(img_scale, label_scale,
                                                 (ori_rows, ori_cols),
    ...
    def scale_process(self, img, label, ori_shape, crop_size, stride_rate,
        ...
        if long_size <= crop_size:
            ...
            score = self.val_func_process(input_data, label, device)
