...
class ObjectContext(nn.Module):
    def __init__(self, in_channels, inner_channel, norm_layer=nn.BatchNorm2d):
        ...
        self.intra_similarity_branch = nn.Sequential(
            ...
            nn.Conv2d(self.inner_channel, 4096, 1, 1, 0, groups=64, bias=False),
            norm_layer(4096)
        )
    ...
    def forward(self, x):
        ...
        intra_context = intra_context.div_(4096)
        ...
        inter_context = inter_context.div_(4096)
