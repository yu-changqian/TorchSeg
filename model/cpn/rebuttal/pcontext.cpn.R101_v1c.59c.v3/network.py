...
class SymmetricConv(nn.Module):
    def __init__(self, in_channels, ksize, norm_layer=nn.BatchNorm2d):
        ...
        padding = ksize // 2
        self.t1 = nn.Conv2d(in_channels, in_channels,
                            kernel_size=(ksize, 1),
                            stride=1, padding=(padding, 0))
        self.t2 = nn.Conv2d(in_channels, in_channels,
                            kernel_size=(1, ksize),
                            stride=1, padding=(0, padding))
        self.p1 = nn.Conv2d(in_channels, in_channels,
                            kernel_size=(1, ksize),
                            stride=1, padding=(0, padding))
        self.p2 = nn.Conv2d(in_channels, in_channels,
                            kernel_size=(ksize, 1),
                            stride=1, padding=(padding, 0))
