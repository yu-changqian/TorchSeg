...
with Engine(custom_parser=parser) as engine:
    ...
    params_list = group_weight(params_list, model.backbone,
                               BatchNorm2d, base_lr)
    params_list = group_weight(params_list, model.context.reduce_conv,
                               BatchNorm2d, base_lr)
    params_list = group_weight(params_list, model.context.intra_post_conv,
                               BatchNorm2d, base_lr)
    params_list = group_weight(params_list, model.context.inter_post_conv,
                               BatchNorm2d, base_lr)
    params_list = group_weight(params_list,
                               model.context.intra_similarity_branch,
                               BatchNorm2d, base_lr * 10)
    params_list = group_weight(params_list, model.aux_layer, BatchNorm2d,
                               base_lr * 10)
    params_list = group_weight(params_list, model.head_layer, BatchNorm2d,
                               base_lr * 10)
